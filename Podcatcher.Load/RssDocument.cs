...
namespace Podcatcher.Load
{
    ...
    public partial class rss : IRssDocument
    {
        ...
        string IRssDocument.Description
        {
            get
            {
        ...
        IEnumerable<IRssItem> IRssDocument.Items
        {
            get
            {
        ...
        //string IRssDocument.PictureLink
        //{
        //    get
        //    {
        ...
        //string IRssDocument.PictureTitle
        //{
        //    get
        //    {
        ...
        string IRssDocument.PictureUrl
        {
            get
            {
                return channel.image.href;
    ...
    /// <remarks/>
    [System.Xml.Serialization.XmlTypeAttribute(AnonymousType = true)]
    public partial class rssChannelItem : IRssItem
    {
        ...
        DateTime? IRssItem.Published
        {
            get
            {
                DateTime pub;
                if (DateTime.TryParse(pubDate, out pub))
                    return pub;
                else
                    return null;
            }
